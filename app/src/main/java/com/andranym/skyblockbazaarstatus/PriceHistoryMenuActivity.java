...
public class PriceHistoryMenuActivity extends AppCompatActivity {
    ...
    static final Migration MIGRATION_1_2 = new Migration(1, 2) {
        ...
        public void migrate(SupportSQLiteDatabase database) {
            database.execSQL("ALTER TABLE BazaarItem ADD COLUMN buyMovingWeek TEXT");
            database.execSQL("ALTER TABLE BazaarItem ADD COLUMN sellMovingWeek TEXT");
            database.execSQL("ALTER TABLE BazaarItem ADD COLUMN sellVolume TEXT");
            database.execSQL("ALTER TABLE BazaarItem ADD COLUMN buyVolume TEXT");
        }
    };
}